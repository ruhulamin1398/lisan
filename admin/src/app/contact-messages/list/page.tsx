                ...
                <div className="mt-6">
                    ...
                    {filteredMessages.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <p className="mt-1 text-sm text-gray-500">
                                {filter === 'all' ? 'No contact messages yet.' :
                        ...
                        <div className="bg-white shadow overflow-hidden sm:rounded-md">
                            <ul className="divide-y divide-gray-200">
                                {filteredMessages.map((message) => (
                                    <li key={message._id} className={`${!message.read ? 'bg-blue-50' : ''}`}>
                                        <div className="px-4 py-4 sm:px-6">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="flex items-center space-x-3 ml-4">
                                                    <button
                                                        onClick={() => toggleRead(message._id, message.read)}
                                                        className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${message.read
                                                    ...
                                                    <Link
                                                        href={`/contact-messages/${message._id}`}
