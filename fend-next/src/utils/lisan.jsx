...
import lisanImg from "../../images/lisan.png";
...
export const configLisan = {
    ...
    publicationList: [
      {
        ...
        description:
          "Innovative Infrastructure Solutions (Springer), 2025. [DOI: 10.1007/s42107-025-01512-7].",
        authors:
          "Sourov Paul, <b>Lesanoor Rahman </b>, Asmaul Husna Chara, Md Mahmuduzzaman, Abul Kashem, Md Naim, Rafrad Bhuiyan & Somir Chandra Malo ",
        link: {
          IEEE: "https://link.springer.com/article/10.1007/s42107-025-01512-7",
          Scholar: "#",
          ResearchGate: "#",
          hideLinsks: true,
        },
  ...
  socialLinks: {
    linkedin: {
      link: "https://www.linkedin.com/in/lesanoorrahman",
      title: "LinkedIn",
      Icon: RiLinkedinFill,
      color: "#2952E3",
    ...
    email: {
      ...
      title: "Email",
      text: "lesanoorrahman@gmail.com",
      Icon: RiMailFill,
      color: "#2952E3",
    },
    whatsapp: {
      link: "https://wa.me/8801775208687",
      title: "Whatsapp",
      text: "+8801775208687",
      Icon: RiWhatsappFill,
      color: "#25D366",
  ...
  heroContent: {
    ...
    overViewList: [
      {
        title: "Resercher",
        description: "Published 2 papers and another few are in review.",
