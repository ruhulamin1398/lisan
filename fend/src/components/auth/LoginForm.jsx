    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                navigate("/admin", { replace: true }); // Navigate programmatically
    ...
    return (
        <div className=" w-[200px] md:w-[500px] bg-white shadow-md mt-10 p-4 md:p-8 rounded-lg">
            <div className="bg-deep-dark p-2 md:pt-4 rounded-t-lg">
                <h2 className="text-lg md:text-2xl font-bold text-[#2a303d] text-center">User Login</h2>
            </div>
            <div className="p-3 md:p-3">
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        <label htmlFor="identifier" className="block text-gray-900 font-medium mb-2 text-sm md:text-base">
                            Username or Email
                        </label>
                        <input
                            type="text"
                    ...
                    <div className="mb-4">
                        <label htmlFor="password" className="block text-gray-900 font-medium mb-2 text-sm md:text-base">
                            Password
                        </label>
                        <input
                            type="password"
