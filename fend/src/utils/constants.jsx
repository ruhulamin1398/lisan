...
if (import.meta.env.VITE_ENV === "ruhul-dev") {
  config = configDev;
}
...
// Make sure fabricLogo and metamaskLogo are imported or available in scope
...
export const logos = [
  ...
  },
  {
    title: "Solana",
    logo: (
      <TbCurrencySolana fontSize={60} className="text-[#c8c8c8] mx-auto py-2" />
    ),
    customStyle: "text-[#c8c8c8]",
  },
  {
    title: "Solidity",
    logo: <SiSolidity fontSize={60} className="text-[#c8c8c8] mx-auto py-2" />,
    customStyle: "text-[#c8c8c8]",
  },
  {
    title: "Hard Hat",
